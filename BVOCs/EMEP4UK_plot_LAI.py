...
if __name__=='__main__':
    ...
    LAI_infileUK = '/users/eow/edwcom/EMEP/EMEP4UK/EMEP4UK_LAI.noIAM'
    LAI_infileEU = '/users/eow/edwcom/EMEP/EMEP4UK/EMEP4UK_EUROPE_LAI.nc.noIAM'
