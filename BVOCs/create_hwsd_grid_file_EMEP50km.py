...
if __name__=='__main__':
        ...
        #outfile='/users/eow/edwcom/EMEP/hwsd2emep/input_data/grid_files/hwsd_30arcsec_rebinned.nc'
        ...
        indata=g.grid_to_vect(inf.variables['mu'][:])
...
#
#	# Open output file
#        print "opening file: "+outfile+".latcors"
#        outf=nc.Dataset(outfile+".latcors",'w',format='NETCDF3_CLASSIC')
#	
#        # create dimensions
#        outf.createDimension('grid_size',grid_size)
#        outf.createDimension('grid_corners',4)
...
#
#	# Open output file
#        print "opening file: "+outfile+".loncors"
#        outf=nc.Dataset(outfile+".loncors",'w',format='NETCDF3_CLASSIC')#
#	
#        # create dimensions
#        outf.createDimension('grid_size',grid_size)
#        outf.createDimension('grid_corners',4)
