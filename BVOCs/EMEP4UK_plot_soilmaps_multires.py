...
class plotsoilmaps:
        def parse_input(self):
            ...
            # optional
            parser.add_argument('--bc',type=bool,help='Flag to plot Brooks & Corey parameters',required=False,default=False)
            ...
            #
            return args.indir, args.outdir, args.bc, args.LATDEL, args.LONDEL, args.RIVERS
...
if __name__=='__main__':
    #
    psm=plotsoilmaps()
    indir,outdir,bc,LATDEL,LONDEL,RIVERS=psm.parse_input()
    ...
    infile1=indir+'EMEP4UK_EUROPE_soilparams_hwsd_'+tag+'.nc'
    infile2=indir+'EMEP4UK_soilparams_hwsd_'+tag+'.nc'
    ...
    if (bc):
            sathh1=inf1.variables['sathh'][0,:,:]
            b1=inf1.variables['b'][0,:,:]
    else:
            oneoveralpha1=inf1.variables['oneoveralpha'][0,:,:]
            oneovernminusone1=inf1.variables['oneovernminusone'][0,:,:]
    hcap1=inf1.variables['hcap'][0,:,:]
    hcon1=inf1.variables['hcon'][0,:,:]
    satcon1=inf1.variables['satcon'][0,:,:]
    vcrit1=inf1.variables['vcrit'][0,:,:]
    vsat1=inf1.variables['vsat'][0,:,:]
    vwilt1=inf1.variables['vwilt'][0,:,:]
    cs1=inf1.variables['cs'][0,:,:]
    inf1.close()
    #
    #
