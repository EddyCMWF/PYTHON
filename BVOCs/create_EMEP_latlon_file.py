...
if __name__=='__main__':
	...
	e=extract()
        ...
        outfile='/users/eow/edwcom/EMEP/EMEP4UK/EMEP4UK_EUROPE_latlon_file.nc'
        infile='/users/eow/edwcom/EMEP/EMEP4UK/wrfout_d01_2001-12-30_00:00:00'
        
        inf=nc.Dataset(infile,'r')
        
        glon = inf.variables['lon'][:]
        glat = inf.variables['lat'][:]
