...
kappa = 340.0                                  # (W/m/K)
lambda_l = 1.142                               # (W/m2/K)
lambda_o = 1.351                               # (W/m2/K)
mu = 1.585                                     # Unitless
...
co2_atmos_ppmv_init = 286.085                  # (ppm)
...
# At end of year, now update atmospheric CO2 concentration and radiative forcing
         ...
         #d_ocean_atmos, fa_ocean = ocean_co2.ocean_co2(j, co2_atmos_ppmv, co2_atmos_ppmv_init, t_ocean_new[0],
         #   fa_ocean,ocean_area,co2_atmos_change_ppmv,nyr,t_ocean_init,nfarray)
...
#         print 'year, CO2 concs, temp_0, total Q = ', j+1860, co2_atmos_ppmv, t_ocean_new[0], q
         print 'year, CO2 concs, emiss, d_land_atmos, d_ocean_atmos', j+1860, co2_atmos_ppmv, conv*emiss_in[j], d_land_atmos, d_ocean_atmos

# Collect data for plotting 1861-2100 
      if (j > 0):
         if (i_change == 0):
            yr_plot[j-1]=j+1860
            co2_plot[j-1]=co2_atmos_ppmv
            ...
            co2_plot_change[j-1]=co2_atmos_ppmv
