...
CANHT_index=((SITE_panda.index>'2011-10-01')&(SITE_panda.index<'2012-09-01')) |\
            ((SITE_panda.index>'2014-10-01')&(SITE_panda.index<'2015-09-01'))
SITE_panda['canht']=SITE_panda['canht'][CANHT_index]

fit_params=['ttveg','alpro','alpst','alple','gamma','kappa'] 
stats=['mean','max','correlation','rmse','rmse_rel','stddev']

TTVEG_opts=['1850', '1900', '1950']#  ,'2000']
#ALPRO_opts=['19.5', '20.0', '20.5']
#ALPST_opts=['15.0', '15.5','16.0']
#ALPLE_opts=['18.0', '18.5', '19.0'] 
ALPRO_opts=['19.5', '20.5', '21.5']
ALPST_opts=['15.0', '16.0','17.0'] 
ALPLE_opts=['17.0', '18.0', '19.0']# , '20.0']
GAMMA_opts=['26.5', '27.5', '28.5' ]
KAPPA_opts=[ '1.70', '1.80', '1.90' ]
...
print(nCONFIGS)
out_fname='/prj/GREENHOUSE/GREENHOUSE_sites/plots/Brattleby/crop_tuning/Calibration1a_fit.txt'
...
long_color_list=['b','g','y','c','orange','aqua','khaki','gold','grey','lime','cadetblue','olive','coral','brown','teal','palegreen']
...
plt.savefig('/prj/GREENHOUSE/GREENHOUSE_sites/plots/Brattleby/crop_tuning/Calibration1a_fit.png',\
...
plt.savefig('/prj/GREENHOUSE/GREENHOUSE_sites/plots/Brattleby/crop_tuning/Calibration1a_NEE.png',\
              bbox_inches='tight')
