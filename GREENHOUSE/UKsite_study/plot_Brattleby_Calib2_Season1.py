...
Season_Limits=('2012-03-01','2012-09-01')
...
pft_index=5
plot_vars=['Sensible Heat Flux','Latent Heat Flux',\
            'Gross Primary Productivity','Net Ecosytem Exchange','Total Ecosystem Respiration']
...
config_names += [r'$\mu$=0.05, DVI$_{senescence}$=1.50, DVI$_{critical}$=2.00']
colors.append( (0.5,0.8,0.5) )
#colors= (0.5,0.8,0.5) 

configs += ['0.02_1.55_1.10']
config_names += [r'$\mu$=0.02, DVI$_{senescence}$=1.10, DVI$_{critical}$=1.55']
colors.append( (0.4,0.4,0.6) )

configs += ['0.05_2.00_1.10']
config_names += [r'$\mu$=0.02, DVI$_{senescence}$=1.10, DVI$_{critical}$=2.00']
colors.append( (0.8,0.5,0.5) )
...
print('Plot saved to:\n'+plot_dir+'/Calibration2_'+plottag+'_Season'+str(iSEAS)+'.png')
