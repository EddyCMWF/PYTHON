...
SITE_index=((SITE_panda.index>'2014-10-01')&(SITE_panda.index<'2015-09-01'))# |\
...
#plottag='TTVEG'
colors  = []
#ttvegs = ('1700','1800','1900','2000')
ttvegs = (['1900'])
nttvegs=len(ttvegs)
nttvegs=0

alros= ('19.7', '19.8', '19.9','20.0') #, '20.1', '20.2', '20.3')
#alros= ('20.1','20.2')
alros= ('20.2', '20.3', '20.4')
#alros= [('20.2')]
nalros=len(alros)
nalros=0

alsts= ('15.7') #, '15.8', '15.9', '16.0' )
...
#plottag='alro_alst_'+ttvegs[0]+'ttv'
...
config_names += [r'TT$_{VEG}$=1900, $\alpha_{root}$=20.3, $\alpha_{stem}$=15.9, $\alpha_{leaf}$=18.0']
...
for iSEAS in [2]:
    for config in configs:
        ...
        temp_index=((temp_panda.index>'2014-10-01')&(temp_panda.index<'2015-10-01')) 
