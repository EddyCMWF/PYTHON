...
Season_Limits=('2014-10-01','2015-10-01')
Corre_Limits=('2015-06-01','2015-10-01')
...
MU_opts=[ '0.015', '0.02', '0.025', '0.03',  ]#, '0.015', '0.04' ]
CRIT_opts= ['1.45', '1.50', '1.55', '1.60', '1.65', '1.70' ]   
#CRIT_opts= ['1.48', '1.49', '1.50', '1.51', '1.52' ]
SEN_opts=[  '1.25', '1.30', '1.35', '1.40', '1.45' ] #, '1.10', '1.15', '1.20', '1.25', '1.30' ] #, '1.15', '1.20' ]'1.00', 
...
index=np.where( \
#               (STAT_dict['lai']['correlation']>lai_corr_min)     & \
