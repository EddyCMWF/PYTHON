...
SITE_index=((SITE_panda.index>'2014-10-01')&(SITE_panda.index<'2015-08-01'))
...
TTVEG_opts=['1900'] 
ALPRO_opts=['20.2', '20.3', '20.4'] 
ALPST_opts=['15.7','15.8','15.9','16.0'] 
ALPLE_opts=['18.0']
GAMMA_opts=['27.3']
KAPPA_opts=['1.40']
...
#configs += ['1850_21.5_15.5_19.0_28.5_1.90']
