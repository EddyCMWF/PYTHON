...
in_SD='/users/eow/edwcom/WFD_EI/start_dumps/WFDEI_startdump_withHWSDSC_ECP20150909.nc'


SC_file='/users/eow/edwcom/BGIcSoilTotal.nc'
SC_param_name='cSoilTotal'

out_SD='/users/eow/edwcom/WFD_EI/start_dumps/WFDEI_startdump_withBGISC_ECP20150909.nc'
l_plot_cs_map=True
plotname='/users/eow/edwcom/WFD_EI/SoilCarbonMap_BGI-HWSD-NCSCD.png'
...
# Fill Nans with closest neighbour
...
if l_plot_cs_map:
    ...
    PT.plot_map(new_SC,sc_lon_2d,sc_lat_2d,\
                ...
                FILE_PLOT=plotname,
                CBAR_LABEL='$kg$C $m^{-2}$',\
                PLOT_TITLE='Soil Carbon - HWSD-NCSCD (BGI)',\
                CBAR_PAD=0.3)
