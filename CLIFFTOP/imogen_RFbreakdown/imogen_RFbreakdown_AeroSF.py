...
SCENARIO = '1p5deg' #'1p81p5deg'  #'2deg'  #'1p5deg' #
Etminan=True
...
out_dir='/prj/CLIFFTOP/IMOGEN_RFbeakdown/plots/toy_jules/'
...
if SCENARIO=='1p5deg':
    ...
    mu_zero = 0.005
    mu_one = 0.00015
    SSP_TAG = 'MESSAGE-GLOBIOM-SSP2-26'
elif SCENARIO=='2deg':
    # First set the 3 parameters in the temperature curves
    dt_limit=2.0
    #mu_zero = 0.065
...
if 'SSP' in Baseline.upper():
    ...
    if l_linearCH4:
        RAD_FORCING_FILE=SCENARIO_DIR+SSP_TAG+'_qnonco2_linear.txt'
        CH4_N2O_FILE=SCENARIO_DIR+SSP_TAG+'_concs_ch4_n2o_linear.txt'
    else:
...
#PLOT_TAG+='_mu0'
#PLOT_TAG='SSP2-2.6_Aerosol_1p5deg_SSP_Tprof_chg_A1+A2te-bt'
print(PLOT_TAG)
...
if l_SSP_Tprof:
    Tprof_file=SCENARIO_DIR+SSP_TAG+'_temp_anomaly_'+SCENARIO+'.dat'
    delta_temp_global=[]
    yr_plot=[]
...
if l_Offset:
    ...
    METHOD_DICT['Offset']={'dq_co2':dq_co2_all,        
                           ...
                           'dq_nonco2':(dq_aerosol_all.transpose()+dq_non_co2_ssp-dq_aerosol_ssp).transpose(),
                           'co2_ppm':co2_ppm_all,      
...
if l_GradientOffset:
    METHOD_DICT['ScaleFactor_Offset']={'dq_co2':dq_co2_GOS_all,        
                           ...
                           'dq_nonco2':(dq_aerosol_GOS_all.transpose()+dq_non_co2_ssp-dq_aerosol_ssp).transpose(),
...
if l_Gradient:
    METHOD_DICT['ScaleFactor']={'dq_co2':dq_co2_G_all,        
                           ...
                           'dq_nonco2':(dq_aerosol_G_all.transpose()+dq_non_co2_ssp-dq_aerosol_ssp).transpose(),
...
if l_DecayOffset:
    ...
    METHOD_DICT['Decaying_Offset']={'dq_co2':dq_co2_DOS_all,
                           ...
                           'dq_nonco2':(dq_aerosol_DOS_all.transpose()+dq_non_co2_ssp-dq_aerosol_ssp).transpose(),
