...
C_emissions_file=optional_argparse('-c_emissions_file','C_emissions.npy')
dq_nonCO2_file=optional_argparse('-dq_nonCO2_file','dq_non_co2_IMAGE-SSP2-2.6.npy')
...
ax.plot(ax.get_xlim(),[now_temp,now_temp],c='k',lw=2)
