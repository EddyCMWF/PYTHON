...
outdir='/users/eow/edwcom/CLIFFTOP/IMOGEN/scenarios/'
co2_concs_infile=outdir+'CO2concRCP.npy'
nonCO2_q_infile=outdir+'TotalNON_CO2.npy'
...
CO2_concentrations=np.load(co2_concs_infile)
