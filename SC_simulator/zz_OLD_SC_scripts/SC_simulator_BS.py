...
JULES_output_dir  = '/users/eow/edwcom/SC_simulator/JULES_output/WFDEI_BigSpin/'
JULES_file        = JULES_output_dir+'JULES_v4.3_WFDEI_TRIFFID_RsQ10_GLOBAL_BigSpin.monthly_mean.nc'
#
# Output Dir
OUT_DIR = '/users/eow/edwcom/SC_simulator/output/'
out_tag = 'SCsim_J4.3_WFDEI_BigSpinLAI_MarthewsTI'
#
