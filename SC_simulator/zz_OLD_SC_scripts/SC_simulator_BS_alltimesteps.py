...
out_tag = 'SCsim_J4.3_WFDEI_BigSpinLAI_alltimesteps_MarthewsTI'
#
...
PFTfrac    = inf.variables['frac'][:,:5,:,:].squeeze()
...
LAI     = LAI.transpose(1,0,2)
LST     = LST.transpose(1,0,2)
PFTfrac = PFTfrac.transpose(1,0,2)
...
Soil_Resp_Fact_Q10t = J_SC_F.JULES_SOIL_RESPIRATION( Carbon_Ones, T_soil,     \
                                                     SM_sthu, SMwilt_sthu,  \
                                                     VEGfrac, Tfunc='Q10',    \
                                                     OUTPUT_opt='pools'  )
# multiply by ICEmask
...
Soil_Resp_Fact_RothCt = J_SC_F.JULES_SOIL_RESPIRATION( Carbon_Ones, T_soil,    \
                                                       SM_sthu, SMwilt_sthu, \
                                                       VEGfrac, Tfunc='RothC', \
                                                       OUTPUT_opt='pools')
# multiply by ICEmask
...
Soil_Resp_Fact_singlepool_Q10t = \
    J_SC_F.JULES_SOIL_RESPIRATION( Carbon_Ones[0,:].reshape(temp_CarbonShape), \
                                   T_soil,SM_sthu,SMwilt_sthu, \
                                   VEGfrac, Tfunc='Q10',OUTPUT_opt='pools',  \
                                   kappa=kappa_s_1SC )
...
Soil_Resp_Fact_singlepool_RothCt = \
    J_SC_F.JULES_SOIL_RESPIRATION( Carbon_Ones[0,:].reshape(temp_CarbonShape), \
                                   T_soil,SM_sthu,SMwilt_sthu, \
                                   VEGfrac, Tfunc='RothC',OUTPUT_opt='pools', \
                                    kappa=kappa_s_1SC )
