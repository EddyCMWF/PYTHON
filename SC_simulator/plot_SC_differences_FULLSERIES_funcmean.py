...
SC_BS_FULLSERIES_file = 'CRUNCEPn96_simulation_JULESoutput_BigSpin_FULL_SERIES_funcmean_FastSoilCarbon.nc'
...
JULES_BS_SoilCarbon_mean_2D=np.mean(JULES_BS_SoilCarbon_mnth[:,:,index],axis=1)
