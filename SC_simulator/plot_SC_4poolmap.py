...
SoilCarbon_files  = [ JULES_output_dir+'WFDEI_pheno/JULES_v4.3_WFDEI_RsQ10_GLOBAL_pheno.monthly_mean.nc',                 \
                      JULES_output_dir+'WFDEI_TRIFFID/JULES_v4.3_WFDEI_TRIFFID_RsQ10_GLOBAL_BigSpin.monthly_mean.nc',     \
                      JULES_output_dir+'WFDEI_TRIFFID/JULES_v4.3_WFDEI_TRIFFID_RsQ10_GLOBAL_QuickSpin.monthly_mean.nc', \
                      JULES_output_dir+'WFDEI_nocomp/JULES_v4.3_WFDEI_TRIFFID_RsQ10_GLOBAL_BigSpin_nocomp.monthly_mean.nc',\
                      JULES_output_dir+'WFDEI_nocomp/J4.3_WFDEI_TRIF_Q10_GLOBAL_QS_nocomp.monthly_mean.nc',               \
