...
JULES_sources, JULES_sources_info = di_SC.jules_sources_info_chess()
...
print Carbon_Ones.shape
print T_soil_work.shape
print SM_sthu_work.shape
print SMwilt_work.shape
print VEGfrac_work.shape
