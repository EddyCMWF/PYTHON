...
DATA_DIR   ='/prj/GREENHOUSE/SC_simulator/JULES_output/WFDEI_KovenMethod/'
...
for iPOOL in range(nPOOLs):
    ...
    for iZON in range(len(indexes)):
        ...
        AX.plot(years_2,K2_CS_timeseries,lw=2,color=colours[iZON])
...
if (iDISPLAY=='Y'):
    ...
    FIG.savefig(OUTPUT_DIR+'WFDEI_KovenSpinUp_Timeseries.png')
    plt.close()
