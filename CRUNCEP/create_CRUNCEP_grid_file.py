...
infile='/users/eow/edwcom/CRUNCEP/cruncep-land-mask.nc'
outfile='/users/eow/edwcom/CRUNCEP/cruncep-gridfile.nc'
...
outvar=outf.createVariable('grid_center_lat','float64',('grid_size'))
outvar.units='degrees'
outvar[:]=latitudes

outvar=outf.createVariable('grid_center_lon','float64',('grid_size'))
outvar.units='degrees'
outvar[:]=longitudes
...
outvar=outf.createVariable('grid_corner_lat','float64',('grid_size','grid_corners'))
outvar.units='degrees'
outvar[:]=latcorn

outvar=outf.createVariable('grid_corner_lon','float64',('grid_size','grid_corners'))
outvar.units='degrees'
outvar[:]=loncorn

outf.title="CRUNCEP 0.5 degree grid"
