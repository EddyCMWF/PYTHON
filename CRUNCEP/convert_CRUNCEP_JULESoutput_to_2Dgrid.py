...
#
gridfile='/users/eow/edwcom/CRUNCEP/cruncep-land-mask.nc'
#
data_dir='/prj/ALANIS/UM_Modelling/EMISSIONS/a_JASMIN/NCEP_CRU_global/'
#
...
# Open infile and read in variable data
...
for year in range(time_obj[0].year,time_obj[-1].year):
    ...
    outf.title='fch4_wetl from cru-ncep jules-v4.2 with Marthews TI'
